...
\begin{document}
    ...
    \begin{frame}{Nachweis von Quarks}
        \begin{figure}
            ...
            \\[-3mm]{\scriptsize Quelle: \cite{Aaij.2019}}
    ...
    % \printbibheading
        % \printbibliography[nottype=online,heading=subbibliography,title={Bücherquellen und Artikel}, nottype=unpublished]
        % \printbibliography[type=online,heading=subbibliography,title={Onlinequellen}, nottype=unpublished]
